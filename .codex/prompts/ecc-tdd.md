# RCC Command Prompt: /tdd

Source: commands/tdd.md

Use this prompt to run the RCC `tdd` workflow.
...
- Reproducible experiment pipelines (data → train → eval)
- Algorithm baselines against published references
- Multi-stage research workflows (Research → Architect → Build → Eval)
