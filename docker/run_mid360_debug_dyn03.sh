#!/bin/bash
# run_mid360_debug_dyn03.sh — Mid360 Dynamic03 determinism validation
#
# Runs Dynamic03 at -r 1.0 with TOFSLAM_DEBUG_DETERMINISM=1, 3 runs across
# 3 containers in parallel. Mid360 variant of run_avia_debug_dyn03.sh.
#
...
#
# Usage: bash docker/run_mid360_debug_dyn03.sh [LABEL]

set -e
cd "$(dirname "$0")/.."

LABEL="${1:-m360_debug_dyn03_$(date +%Y%m%d_%H%M)}"
OUT_BASE="dump/${LABEL}"
