#!/bin/bash
# run_avia_debug_vi04.sh — Varying-illu04 determinism validation (iter2g-a Step 7 G3)
#
# Runs 3x Varying-illu04 at -r 1.0 with TOFSLAM_DEBUG_DETERMINISM=1.
...
#
# Usage: bash docker/run_avia_debug_vi04.sh [LABEL]

set -e
cd "$(dirname "$0")/.."

LABEL="${1:-avia_debug_vi04_$(date +%Y%m%d_%H%M)}"
OUT_BASE="dump/${LABEL}"
HOST_SURFEL="/home/euntae/Project/dataset/ros1/surfel_data"

SEQ="Varying-illu04"
CFG="avia_v6_seq/varying_illu04.yaml"
RATE="1.0"
