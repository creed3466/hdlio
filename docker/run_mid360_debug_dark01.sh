#!/bin/bash
# run_mid360_debug_dark01.sh — Mid360 Dark01 determinism validation
#
# Runs Dark01 at -r 1.0 with TOFSLAM_DEBUG_DETERMINISM=1, 3 runs across
# 3 containers in parallel. Mid360 variant of run_avia_debug_dark01.sh.
#
...
#
# Usage: bash docker/run_mid360_debug_dark01.sh [LABEL]

set -e
cd "$(dirname "$0")/.."

LABEL="${1:-m360_debug_dark01_$(date +%Y%m%d_%H%M)}"
OUT_BASE="dump/${LABEL}"
