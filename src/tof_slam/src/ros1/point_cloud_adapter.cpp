...
core::PointCloud PointCloudAdapter::convert(
  ...
  const double scan_ts = msg->header.stamp.toSec();
...
core::PointCloud PointCloudAdapter::convert(
  ...
  const bool timestamp_is_double =
      has_timestamp && (ts_datatype == sensor_msgs::PointField::FLOAT64);
  ...
  const bool offset_time_is_uint32 =
      has_offset_time && (ot_datatype == sensor_msgs::PointField::UINT32);
  ...
  const bool t_is_uint32 =
      has_t && (t_datatype == sensor_msgs::PointField::UINT32);
  ...
  const bool time_is_float32 =
      has_time && (time_datatype == sensor_msgs::PointField::FLOAT32);
